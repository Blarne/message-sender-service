...
public class SwaggerConfiguration {
    ...
    public Docket api10(ServletContext servletContext) {
        return new Docket(DocumentationType.SWAGGER_2).groupName("message-sender-api-1.0")
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.karumien.cloud.notification.api"))
...
//            .globalResponseMessage(RequestMethod.PUT, getCustomizedResponseMessages())                    
            ...
            .apiInfo(new ApiInfoBuilder().version("1.0").title("Eurowag Message Sender API Documentation")
            .description("Services of Message Sender API (Notification).")
            .build());
    }
